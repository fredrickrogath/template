<template>
    <app-layout>
        <!-- <template #header>
            ...
            <v-row>
                <v-col v-if="showOnSroll" sm="3" :md="dynamicColForSideBar" offset-lg="1">
                    <!-- md 2 inaipa sidebar area besides the main content area -->
                    <side-bar></side-bar>
                </v-col>
                <v-col sm="9" md="12" offset-sm="7" class="bg-red-800">
                    <!-- md 10 inaipa main content area besides the sidebar area -->
                    <div class="py-0">
                        
            <div class="mx-auto sm:px-6 lg:px-8" :class="contentFullWidthWhenSideBarHides">
                <div class="overflow-hidden shadow-xl sm:rounded-lg bg-green-800">
                    <!-- <welcome /> -->
                    <v-row>
                        <v-col>
                            <v-row>
